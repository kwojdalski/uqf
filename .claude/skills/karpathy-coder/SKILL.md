...
- No "flexibility" or "configurability" that wasn't requested — this library already has one deliberate, explicit precedent for configurability (`.qfwd.time_col`/`.qfwd.col_precedence`, added because the user asked for it); don't add a second config knob speculatively.
