...
/ @return a table with one row per (trade, horizon): `sym`trade_time`horizon`target_time`trade_price`ref_price`markout_pips
...
markout_at_horizons:{[trades;quotes;horizons]
    ...
    ([] sym:exp_trades`sym; trade_time:exp_trades`time; horizon:exp_horizons; target_time; trade_price:exp_trades`trade_price; ref_price; markout_pips)};
