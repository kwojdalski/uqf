...
/ scripts/torq_wide_book_feed.q, where the builder both built AND published.
/ .
...
.qstream.register[`wide_book_feed;`procname`subscribes`publishes`timer_period`on_timer!(
    `widefeed1;
    `symbol$();
    enlist `wide_book;
    0D00:00:00.500;
