...
/ @eg .qdata.cfg[`DATABENTO_DATA_DIR;::]
cfg:{[k;dflt]
    osVal:getenv k;
    if[not osVal~""; :osVal];
...
/ @eg .qdata.databentoFile[`AAPL;2026.02.25]
...
/ @eg .qdata.getBySymbolDate[`AAPL;2026.02.25]
