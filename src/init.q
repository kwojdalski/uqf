...
// .qexec, .qbook, .qmicro, .qex - kept single-level throughout, not nested
// under a shared .q parent, since multi-level \d namespace paths don't
// resolve under the PeachQ interpreter this repo also targets).
