...
/ @return 1+r*t
/ @eg .qrates.growth_simple[0.05;1]  -> 1.05
...
/ @param t year fraction
/ @return exp(r*t)
/ @eg .qrates.growth_cont[0.05;1]  -> 1.051271
...
/ @param t year fraction
/ @return 1/(1+r*t)
/ @eg .qrates.df_simple[0.05;1]  -> 0.952381
...
/ @param t year fraction
/ @return exp(-r*t)
/ @eg .qrates.df_cont[0.05;1]  -> 0.9512294
...
/ @eg .qrates.simple_to_cont[0.05;1]  -> 0.04879016
...
/ @eg .qrates.cont_to_simple[0.04879016;1]  -> 0.05
