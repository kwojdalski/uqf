...
| Databento MBP-10 | [`databento_feed.py`](../../python/torq_orchestrator/src/torq_orchestrator/databento_feed.py) → [`databento_book`](../../src/etl/streaming/databento_book.q) | raw MBP-10, folded by the same `.qxf` transform the ODBC backfill applies |
