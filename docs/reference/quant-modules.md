...
module is *for*.
  ...
  | [`market_data/microstructure.q`](../../src/market_data/microstructure.q) | `.qmicro`  | LOB signals: book pressure, microprice, order flow imbalance, odd-lot share and imbalance, VAMP                                    | [tests](../../tests/q/test_microstructure.q) |
