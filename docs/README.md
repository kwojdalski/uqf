...
or an architecture note, and only its purpose decides where it goes.
  ...
  | [`reference/`](reference/README.md)       | *What is the contract?*                                   | anyone integrating, and CI               | [`quant-modules.md`](reference/quant-modules.md) each `src/` module<br>[`environment.md`](reference/environment.md) every variable, gated<br>[`processes.md`](reference/processes.md) every process, its port and edges, generated<br>[`surfaces/current/`](reference/surfaces/current/) the exported contract surface, generated                                                                                                                                                                                                                                                  |
