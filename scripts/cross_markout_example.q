...
DEBUG "running: .qfwd.cross_book_at[quotes;`AUDPLN;trade_time;enlist 1;enlist `mid]";
...
DEBUG "running: .qfwd.cross_markout_at_horizons[quotes;`AUDPLN;trade_time;1;trade_price;10000;-500 -300 0 100 300;1]";
...
DEBUG "running: .qfwd.cross_markout_decomp[quotes;`AUDPLN;t0;t1;10000;1]";
...
DEBUG "running: .qfwd.cross_impact_at_horizons[quotes;`EURPLN;`EURUSD;trade_time;1;10000;-500 -300 0 100 300;1]";
