...
/ pattern (Normal gaps via this repo's own .uqf.inv_ncdf) at a 1ms
...
DEBUG "running: .uqf.cross_book_at[quotes;`AUDPLN;trade_time;enlist 1;enlist `mid]";
trade_price:first .uqf.cross_book_at[quotes;`AUDPLN;trade_time;enlist 1;enlist `mid]`mid;
INFO ("trade_time/trade_price - a synthetic AUDPLN buy at %1: %2";(trade_time;trade_price));

DEBUG "running: .uqf.cross_markout_at_horizons[quotes;`AUDPLN;trade_time;1;trade_price;10000;-500 -300 0 100 300;1]";
horizons_r:.uqf.cross_markout_at_horizons[quotes;`AUDPLN;trade_time;1;trade_price;10000;-500 -300 0 100 300;1];
...
DEBUG "running: .uqf.cross_markout_decomp[quotes;`AUDPLN;t0;t1;10000;1]";
...
DEBUG "running: .uqf.cross_ref_price_at[quotes;`AUDPLN;1;t0]";
mid_t0:.uqf.cross_ref_price_at[quotes;`AUDPLN;1;t0];
DEBUG "running: .uqf.cross_ref_price_at[quotes;`AUDPLN;1;t1]";
...
DEBUG "running: .uqf.cross_impact_at_horizons[quotes;`EURPLN;`EURUSD;trade_time;1;10000;-500 -300 0 100 300;1]";
impact_r:.uqf.cross_impact_at_horizons[quotes;`EURPLN;`EURUSD;trade_time;1;10000;-500 -300 0 100 300;1];
