...
Usage::
    ...
    python3 scripts/generate/build_decision_log.py            # rewrite docs/decisions/README.md
    python3 scripts/generate/build_decision_log.py --check    # exit 1 if it is stale
...
def render(bank: Bank) -> str:
    ...
    add("")
    add("**Generated by `scripts/generate/build_decision_log.py` - do not edit by hand.**")
...
def main() -> int:
    ...
    if args.check:
        ...
        if problems:
            ...
            print("\nrerun scripts/generate/build_decision_log.py", file=sys.stderr)
            return 1
