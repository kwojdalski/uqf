...
before recording the cursor" in docs/etl-framework-requirements.md and "do
...
Left alone: docs/decisions.md (derived from the bank, regenerated by its
own tool), the drift ledger and docs/restatement-design.md (which discuss
...
RENUMBER_FILES = {
    "README.md",
    "docs/etl-framework-requirements.md",
