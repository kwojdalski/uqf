...
testGkCallHullBenchmark:{[t] .testutil.assertApprox[.uqf.gk_call[42;40;0.10;0f;0.20;0.5];4.759423;1e-4;"Hull BS call benchmark (rf=0)"]};
testGkPutHullBenchmark:{[t] .testutil.assertApprox[.uqf.gk_put[42;40;0.10;0f;0.20;0.5];0.8086;1e-3;"Hull BS put benchmark (rf=0)"]};
...
testCallApproachesDiscountedIntrinsicAsVolShrinks:{[t]
    ...
    tinyVolCall:.uqf.gk_call[s;k;rd;rf;0.0001;tt];
...
testCallIsWorthlessDeepOtmTinyVol:{[t]
    otmCall:.uqf.gk_call[1.10;2.00;0.045;0.02;0.0001;0.1];
...
testImpliedVolRobustForTinyVega:{[t]
    deepOtmPrice:.uqf.gk_call[1.10;2.00;0.045;0.02;0.05;0.05];
    iv:.uqf.implied_vol[deepOtmPrice;1.10;2.00;0.045;0.02;0.05;1b];
