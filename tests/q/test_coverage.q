...
test_coverage_of_one_partition_does_not_cover_another:{[t]
    .qcov.stage_completion[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    .qunit.assertEquals[
        .qcov.is_covered[`markouts;`USDJPY;`v1;.z.p;.coveragetest.d 1;.coveragetest.d 2];
        0b;
...
test_a_partition_covers_its_own_range:{[t]
    .qcov.stage_completion[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    .qunit.assertEquals[
        .qcov.is_covered[`markouts;`EURUSD;`v1;.z.p;.coveragetest.d 1;.coveragetest.d 2];
        1b;
...
test_two_partitions_do_not_compose_into_one_range:{[t]
    .qcov.stage_completion[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    .qcov.stage_completion[`markouts;`USDJPY;`v1;.coveragetest.d 2;.coveragetest.d 3;10];
    .qunit.assertEquals[
        .qcov.is_covered[`markouts;`EURUSD;`v1;.z.p;.coveragetest.d 1;.coveragetest.d 3];
        0b;
...
test_the_gap_a_partition_reports_is_its_own:{[t]
    .qcov.stage_completion[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    .qcov.stage_completion[`markouts;`USDJPY;`v1;.coveragetest.d 2;.coveragetest.d 3;10];
    m:.qcov.missing[`markouts;`EURUSD;`v1;.z.p;.coveragetest.d 1;.coveragetest.d 3];
...
test_an_unpartitioned_read_does_not_see_partitioned_rows:{[t]
    .qcov.stage_completion[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    .qunit.assertEquals[
        .qcov.is_covered[`markouts;`;`v1;.z.p;.coveragetest.d 1;.coveragetest.d 2];
        0b;
...
test_a_partitioned_read_does_not_see_unpartitioned_rows:{[t]
    .qcov.stage_completion[`markouts;`;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    .qunit.assertEquals[
        .qcov.is_covered[`markouts;`EURUSD;`v1;.z.p;.coveragetest.d 1;.coveragetest.d 2];
        0b;
...
test_a_null_partition_is_the_sentinel_not_an_error:{[t]
    .qunit.assertEquals[
        0<.qcov.stage_completion[`markouts;`;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
        1b;
...
test_superseding_one_partition_leaves_another_standing:{[t]
    .qcov.stage_completion[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    .qcov.stage_completion[`markouts;`USDJPY;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    n:.qcov.supersede[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2];
...
test_superseding_one_partition_withdraws_that_partition:{[t]
    .qcov.stage_completion[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2;10];
    .qcov.supersede[`markouts;`EURUSD;`v1;.coveragetest.d 1;.coveragetest.d 2];
    .qunit.assertEquals[
        .qcov.is_covered[`markouts;`EURUSD;`v1;.z.p;.coveragetest.d 1;.coveragetest.d 2];
        0b;
...
test_partition_follows_dataset_in_the_schema:{[t]
    ...
    .qunit.assertEquals[3#.qcov.schema;`dataset`partition`source_version;
