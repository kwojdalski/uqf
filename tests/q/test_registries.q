...
test_a_streaming_job_without_a_timer_does_not_gain_one:{[t]
    ...
    .qstream.define[`regtest_feed;`procname`subscribeto`publishes`period`on_timer!(
        `regtest_feed1;`symbol$();enlist `regtest_out;0D00:00:01;{[] })];
    .qstream.define[`regtest_sub;`procname`subscribeto`publishes`on_batch!(
...
test_a_source_with_a_scalar_row_key_is_stored_as_a_vector:{[t]
    ...
    base:`tablename`target`timecolumn`columns`types`query`fixture`tz!(`regtest_t;`regtest_out;`time;`time`sym;"ps";
