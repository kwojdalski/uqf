...
test_fold_level_columns_orders_level_zero_first_regardless_of_source_column_order:{[t]
    src:wide_book_table[::];
    lg:.uqf.derive_level_groups[cols src;level_prefix_targets];
    folded:.uqf.fold_level_columns[src;lg];
...
test_derive_level_groups_with_a_single_prefix_target:{[t]
    ...
    lg:.uqf.derive_level_groups[`bid_px_00`bid_px_01`bid_px_02`sym;enlist ("bid_px_";`bid_prices)];
...
test_derive_level_groups_rejects_non_contiguous_levels:{[t]
    bad_cols:`bid0`bid2;
    wrapper:{[cn] .uqf.derive_level_groups[cn;enlist ("bid";`bid_prices)]};
...
test_symbolize_columns_casts_string_to_symbol:{[t]
    ...
    out:.uqf.symbolize_columns[src;`sym`side];
...
test_symbolize_columns_is_idempotent_on_already_symbol_column:{[t]
    ...
    once:.uqf.symbolize_columns[src;enlist `sym];
    wrapper:{[tbl] .uqf.symbolize_columns[tbl;enlist `sym]};
    twice:wrapper once;
...
test_candidate_symbol_columns_flags_allowlisted_and_low_cardinality:{[t]
    src:([] sym:("EURUSD";"EURUSD";"EURUSD"); side:("buy";"sell";"buy");
            ...
            n:1 2 3);
    candidates:.uqf.candidate_symbol_columns[src;`sym`side;0.5];
...
test_candidate_symbol_columns_does_not_mutate_table:{[t]
    ...
    before:src;
    candidates:.uqf.candidate_symbol_columns[src;enlist `sym;0.5];
...
test_book_from_wide_levels_composes_fold_then_symbolize:{[t]
    src:wide_book_table[::];
    lg:.uqf.derive_level_groups[cols src;level_prefix_targets];
    out:.uqf.book_from_wide_levels[src;lg;enlist `sym];
