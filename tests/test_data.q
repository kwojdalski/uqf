...
testParseEnvMissingFileReturnsEmptyDict:{[t]
    d:.uqfdata.parseEnv[`:/tmp/uqf_test_data_definitely_does_not_exist.env];
...
testCfgPrefersOsEnvOverDotEnv:{[t]
    ...
    v:.uqfdata.cfg[`UQF_TEST_CFG_KEY;::];
...
testDatabentoFileBuildsExpectedPath:{[t]
    ...
    f:.uqfdata.databentoFile[`aapl;2026.02.25];
