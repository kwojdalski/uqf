...
holds its modules to. The seam is the same one `model/pipeline.py` and `model/registry.py`
already use: this is the SHAPE of a plan, scaffold/jobs.py is what builds and
