...
or, after a one-time `uv tool install --editable python/uqf_stack`:
...
#
# isort: off
from uqf_stack.cli import lifecycle  # noqa: F401
from uqf_stack.cli import summary  # noqa: F401
from uqf_stack.cli import inspect  # noqa: F401
from uqf_stack.cli import create  # noqa: F401
