...
class Pipeline:
    ...
    subscribeto: tuple[str, ...] | _FromDeclaration = ()
    ...
    def schema(self) -> str | None:
        ...
        if self.table is None:
            return None
        from uqs.model.schemas import _DEFS
    ...
    def subscribed_tables(self) -> tuple[str, ...]:
        ...
        The resolved spelling of `subscribeto`, for the same reason
    ...
    def _resolved(self) -> tuple[tuple[str, ...], tuple[str, ...]]:
        ...
        from uqs.model.pipeline_edges import resolve_edges
